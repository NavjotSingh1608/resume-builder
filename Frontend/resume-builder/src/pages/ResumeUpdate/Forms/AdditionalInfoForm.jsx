...
const AdditionalInfoForm = ({languages,interests,updateArrayItem,removeArrayItem,addArrayItem}) => {
  return (
...
<div className="mt-6">
  ...
  <div className="flex flex-col gap-4">
    {languages.map((lang, index) => (
      <div key={index}
       className="border border-gray-200/80 rounded-lg p-4 relative"
       >
...
<div className="mt-8 mb-4 ">
  ...
  value={typeof interest === "string" ? interest : ""}
  onChange={({ target }) =>
    updateArrayItem("interests", index, "value", target.value)
...
/>
        ...
        {interests.length > 1 && (
          <button
            type="button"
            className="absolute top-6 right-3 text-sm text-red-600 hover:underline cursor-pointer"
