...
const ProjectsDetailForm = ({projectInfo,updateArrayItem,addArrayItem,removeArrayItem}) => {
 ...
 <div className='px-5 pt-5'>
    ...
    <div className='mt-4 flex flex-col gap-4 mb-3'>
            ...
            className='border border-gray-200/80 rounded-lg p-4 relative'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div className='col-span-2'>
                        ...
                        <textarea
                         placeholder='Short desscription about the project'
                         className='form-input w-full mt-14'
                         rows={3}
        ...
        <button className='self-start flex items-center gap-2 px-4 py-2 rounded bg-purple-100 text-purple-800 text-sm font-medium hover:bg-purple-200 cursor-pointer'
        type='button'
