...
<div className='w-full min-h-full bg-white'>
  <div className='container mx-auto px-4 py-6'>
    ...
    <header className='flex justify-between items-center mb-16'>
     ...
     {user ?<ProfileInfoCard/>: <button className='bg-purple-100 text-sm font-semibold text-black px-7 py-2.5 rounded-lg hover:bg-gray-800 hover:text-white transition-colors cursor-pointer' onClick={()=> setOpenAuthModal(true)}>Login/Sign Up</button>
    }
     </header>
     ...
     <div className='flex flex-col md:flex-row items-center '>
      <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0 '>
        ...
        <p className='text-lg text-gray-700 mb-8 '>Craft a standout resume in minutes with our smart and intuitive resume builder.</p>
    ...
    <section className='mt-5'>
      <h2 className='text-2xl font-bold text-center mb-12 '>Features That Makes You Shine</h2>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
        ...
        <div className='bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition'>
          ...
          <p className='text-gray-600'> Choose from modern, proffessional templates that are easy to customize.</p>
        </div>
