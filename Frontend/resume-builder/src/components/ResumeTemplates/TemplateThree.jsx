...
const TemplateThree = ({resumeData,colorPalette,containerWidth}) => {
    ...
    const [baseWidth,setBaseWidth]= useState(800); //default
...
>
  ...
  <div className='flex items-start gap5 px-2 mb-5'>
    <div className='w-[100px] h-[100px] max-w-[105px] rounded-2xl flex items-center justify-center' style={{backgroundColor:themeColors[1]}}>
      {resumeData.profileInfo.profilePreviewUrl?(
        ...
        <div className='w-[90px] h-[90px] flex items-center justify-center text-5xl rounded-full' style={{color:themeColors[4]}}><LuUser/></div>
      )}
    </div>
      ...
      <div>
        ...
        <div className='grid grid-cols-12 gap-1'>
            ...
            <div className='col-span-8 pt-10 mr-10 pb-5 ml-4'>
                <div>
